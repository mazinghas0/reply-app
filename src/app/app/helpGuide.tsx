...
const SECTIONS: GuideSection[] = [
  {
    id: "generate",
    title: "답장 만들기",
    description: "받은 메시지를 붙여넣고 톤을 고르면 AI가 답장 3개를 만들어요.",
    tips: [
      "톤 4종: 정중 / 단호 / 유연 / 친근",
      "맞춤형 답장: 관계 > 목적 > 전략 3단계로 더 정확한 답장",
      "빠른 모드: 짧고 빠르게 / 정교한 모드: 더 자연스럽게",
      "Ctrl+Enter (Mac: Cmd+Enter)로 빠르게 생성",
      "히스토리에서 이전 답장을 다시 볼 수 있어요",
    ],
  },
  {
    id: "review",
    title: "답장 검토",
    description: "내가 쓴 답장을 넣으면 AI가 꼼꼼하게 체크해 줘요.",
    tips: [
      "맞춤법: 틀린 곳을 찾아서 교정 제안",
      "톤 분석: 내 메시지가 어떤 톤인지 점수로 알려줘요",
      "인상 분석: 상대방이 이 메시지를 보면 어떤 느낌일지 예측",
      "개선 제안: 더 좋은 표현이 있으면 추천해 줘요",
      "상황 설명을 추가하면 더 정확한 검토가 가능해요",
    ],
  },
  {
    id: "refine",
    title: "다듬기",
    description: "대충 쓴 답장을 톤에 맞게 깔끔하게 다듬어 드려요.",
    tips: [
      "톤 5종: 자연스럽게 / 정중 / 단호 / 유연 / 친근",
      "원문과 비교해서 어떻게 바뀌었는지 확인 가능",
      "결과를 바로 복사해서 메신저에 붙여넣기",
      "AI 느낌 없이 실제 한국어 문체로 다듬어요",
    ],
  },
];
